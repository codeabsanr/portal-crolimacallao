    ...
    <section class="py-10 md:py-14 bg-background-light">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="mb-8">
                ...
                <p class="text-text-main mt-2">Panel privado para gestión de cuenta, pagos, notificaciones y trámites del colegiado.</p>
            </div>
            ...
            <div class="mt-8 rounded-xl border border-primary/25 bg-white p-6 md:p-8 shadow-[0_20px_34px_-30px_rgba(15,23,42,0.5)]">
                ...
                <p class="text-text-main mt-3">Esta sección está protegida con autenticación y corresponde al entorno interno del Portal del Colegiado.</p>
            </div>
        </div>
    </section>
</main>
