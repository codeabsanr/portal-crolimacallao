...
<main class="md:h-screen md:overflow-hidden flex flex-col md:flex-row">
    <section class="relative w-full md:w-[66%] md:h-screen md:overflow-y-auto bg-background-light border-r border-slate-300/80">
        ...
        <div class="relative z-10 mx-auto w-full max-w-5xl px-5 sm:px-6 lg:px-10 py-8 md:py-12">
            ...
            <p class="mt-4 max-w-3xl text-base md:text-lg text-text-main">Conecta entidades empleadoras con mas de 13,000 colegiadas y colegiados en un entorno de validacion profesional.</p>
            ...
            <form class="mt-8 rounded-md border border-primary/35 bg-white p-2">
                <div class="grid gap-2 sm:grid-cols-[1fr_220px_180px]">
                    <div class="flex items-center gap-3 px-3 sm:px-4 py-3">
                        <span class="material-icons-outlined text-2xl text-text-main">search</span>
                        <input type="text" class="w-full border-none bg-transparent text-base font-medium text-secondary placeholder:text-text-main focus:ring-0" placeholder="Buscar vacante por puesto o institucion">
                    </div>
                    <select class="border border-slate-200 bg-white text-sm font-semibold text-text-main focus:border-primary focus:ring-primary/20">
            ...
            <div class="mt-4 grid sm:grid-cols-3 gap-3">
                <div class="border border-slate-200 bg-white p-4">
                    <p class="text-xs uppercase tracking-[0.12em] text-text-main font-bold">Vacantes activas</p>
                    <p class="mt-1 text-2xl font-black text-secondary">48</p>
                </div>
                <div class="border border-slate-200 bg-white p-4">
                    <p class="text-xs uppercase tracking-[0.12em] text-text-main font-bold">Instituciones aliadas</p>
                    <p class="mt-1 text-2xl font-black text-secondary">36</p>
                </div>
                <div class="border border-slate-200 bg-white p-4">
                    <p class="text-xs uppercase tracking-[0.12em] text-text-main font-bold">Perfiles disponibles</p>
                ...
                <article class="inst-card border border-primary/20 bg-white p-4">
                    <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
                        <div>
                            ...
                            <p class="text-sm text-text-main mt-1">Clinica San Gabriel · Lima · Contrato a plazo fijo</p>
                            <p class="text-sm text-text-main mt-2">Requisitos: COP habilitado, 2 anos de experiencia en centro obstetrico.</p>
                        </div>
                ...
                <article class="inst-card border border-primary/20 bg-white p-4">
                    <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
                        <div>
                            ...
                            <p class="text-sm text-text-main mt-1">DIRIS Lima Centro · Lima · Locacion de servicios</p>
                            <p class="text-sm text-text-main mt-2">Requisitos: experiencia en atencion primaria y promocion de salud materna.</p>
                        </div>
                        <div class="flex flex-col items-start sm:items-end gap-2">
                            <span class="inline-flex rounded-sm border border-emerald-300 bg-emerald-50 px-3 py-1 text-xs font-bold uppercase tracking-[0.12em] text-emerald-700">Activa</span>
                            <button type="button" class="inst-btn-primary !px-4 !py-2 !text-xs">Postular</button>
                ...
                <article class="inst-card border border-primary/20 bg-white p-4">
                    <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
                        <div>
                            ...
                            <p class="text-sm text-text-main mt-1">Universidad del Callao · Callao · Medio tiempo</p>
                            <p class="text-sm text-text-main mt-2">Requisitos: colegiatura vigente y experiencia en docencia o capacitacion.</p>
                        </div>
                        <div class="flex flex-col items-start sm:items-end gap-2">
                            <span class="inline-flex rounded-sm border border-emerald-300 bg-emerald-50 px-3 py-1 text-xs font-bold uppercase tracking-[0.12em] text-emerald-700">Activa</span>
                            <button type="button" class="inst-btn-primary !px-4 !py-2 !text-xs">Postular</button>
