...
@section('content')
    <x-institucional-page-shell
        ...
        <article class="inst-card overflow-hidden">
            <div class="grid lg:grid-cols-[1fr_1.2fr]">
                ...
                <div class="p-6 md:p-8">
                    <h2 class="text-2xl font-black text-text-main mb-4">Normatividad institucional</h2>
        ...
        <article class="inst-card p-6 md:p-8">
            <h3 class="text-xl font-black text-text-main mb-5">Normas institucionales principales</h3>
            <ol class="list-decimal pl-5 space-y-2 text-text-main">
        ...
        <div class="grid md:grid-cols-2 gap-4">
            <article class="inst-card p-5 border-t-2 border-t-primary hover:shadow-hard transition-all">
                <h3 class="text-xl font-black text-text-main mb-3">Leyes</h3>
                <p class="text-text-main">Normas nacionales relacionadas con salud, regulación profesional, derechos laborales y ejercicio sanitario.</p>
            </article>
            <article class="inst-card p-5 border-t-2 border-t-primary hover:shadow-hard transition-all">
                <h3 class="text-xl font-black text-text-main mb-3">Normas técnicas y guías</h3>
                <p class="text-text-main">Lineamientos de atención integral, emergencias obstétricas y buenas prácticas clínicas.</p>
            </article>
        </div>

        <article class="inst-card p-6 md:p-8 bg-primary-mist border-slate-200">
            <h3 class="text-xl font-black text-text-main mb-3">Recomendación de consulta</h3>
            <p class="text-text-main">
