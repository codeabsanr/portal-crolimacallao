    ...
    <x-institucional-page-shell
        ...
        <article class="inst-card overflow-hidden border border-slate-300">
            <div class="grid lg:grid-cols-[1.2fr_1fr]">
                ...
                <div class="p-6 md:p-8">
                    ...
                    <h2 class="text-2xl font-black text-text-main mb-4">Identidad y propósito</h2>
                    <div class="space-y-3 text-text-main">
                    ...
                    <div class="mt-5 border-l-2 border-primary pl-4">
                        <p class="text-sm italic text-text-main">“Nuestra labor institucional se orienta a la calidad del ejercicio profesional y al servicio responsable de la salud de la mujer.”</p>
                    </div>
                </div>
            </div>
        </article>
        ...
        <div class="grid sm:grid-cols-2 xl:grid-cols-4 gap-4">
            <article class="inst-card p-5 border-t-2 border-t-primary hover:shadow-hard transition-all">
                <p class="text-xs uppercase tracking-[0.14em] text-text-main">Creación legal</p>
                <p class="text-2xl font-black text-text-main mt-2">D.L. 21210</p>
            </article>
            <article class="inst-card p-5 border-t-2 border-t-primary hover:shadow-hard transition-all">
                <p class="text-xs uppercase tracking-[0.14em] text-text-main">Jurisdicción</p>
                <p class="text-xl font-black text-text-main mt-2">Lima - Callao</p>
            </article>
            <article class="inst-card p-5 border-t-2 border-t-primary hover:shadow-hard transition-all">
                <p class="text-xs uppercase tracking-[0.14em] text-text-main">Naturaleza</p>
                <p class="text-xl font-black text-text-main mt-2">Sin fines de lucro</p>
            </article>
            <article class="inst-card p-5 border-t-2 border-t-primary hover:shadow-hard transition-all">
                <p class="text-xs uppercase tracking-[0.14em] text-text-main">Sede principal</p>
                <p class="text-xl font-black text-text-main mt-2">Pueblo Libre</p>
            </article>
        </div>

        <article class="inst-card p-6 md:p-8">
            <h3 class="text-2xl font-black text-text-main mb-5">Pilares de acción institucional</h3>
            <div class="grid md:grid-cols-3 gap-4">
                <div class="border border-slate-200 p-4 bg-primary-mist hover:bg-white transition-colors">
                    ...
                    <p class="font-bold text-text-main mt-2">Representación gremial</p>
                    <p class="text-sm text-text-main mt-1">Defensa de derechos profesionales y articulación con entidades públicas y privadas.</p>
                </div>
                <div class="border border-slate-200 p-4 bg-primary-mist hover:bg-white transition-colors">
                    <span class="material-icons-outlined text-primary text-2xl">school</span>
                    <p class="font-bold text-text-main mt-2">Fortalecimiento profesional</p>
                    <p class="text-sm text-text-main mt-1">Impulso de capacitación científica y desarrollo de competencias para el ejercicio seguro.</p>
                </div>
                <div class="border border-slate-200 p-4 bg-primary-mist hover:bg-white transition-colors">
                    <span class="material-icons-outlined text-primary text-2xl">favorite</span>
                    <p class="font-bold text-text-main mt-2">Compromiso social</p>
                    <p class="text-sm text-text-main mt-1">Promoción de la salud de la mujer y de buenas prácticas en salud sexual y reproductiva.</p>
                </div>
            </div>
        </article>
