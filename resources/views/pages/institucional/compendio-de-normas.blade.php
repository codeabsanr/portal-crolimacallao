    ...
    <x-institucional-page-shell
        ...
        <article class="inst-card p-6 md:p-8">
            ...
            <div class="grid md:grid-cols-2 gap-4">
                <div class="border border-slate-200 p-4 bg-slate-50 border-l-2 border-l-primary"><p class="font-bold text-slate-900">Leyes nacionales</p><p class="text-sm text-slate-700 mt-1">Normas base del ejercicio profesional y sanitario.</p></div>
                <div class="border border-slate-200 p-4 bg-slate-50 border-l-2 border-l-primary"><p class="font-bold text-slate-900">Estatutos institucionales</p><p class="text-sm text-slate-700 mt-1">Reglas orgánicas de funcionamiento y gobierno.</p></div>
                <div class="border border-slate-200 p-4 bg-slate-50 border-l-2 border-l-primary"><p class="font-bold text-slate-900">Reglamentos internos</p><p class="text-sm text-slate-700 mt-1">Procedimientos y lineamientos de aplicación institucional.</p></div>
                <div class="border border-slate-200 p-4 bg-slate-50 border-l-2 border-l-primary"><p class="font-bold text-slate-900">Resoluciones regionales</p><p class="text-sm text-slate-700 mt-1">Disposiciones de alcance administrativo y profesional.</p></div>
                <div class="border border-slate-200 p-4 bg-slate-50 border-l-2 border-l-primary"><p class="font-bold text-slate-900">Normas técnicas</p><p class="text-sm text-slate-700 mt-1">Guías y criterios para práctica obstétrica segura.</p></div>
                <div class="border border-slate-200 p-4 bg-slate-50 border-l-2 border-l-primary"><p class="font-bold text-slate-900">Documentos administrativos</p><p class="text-sm text-slate-700 mt-1">Formatos y referencias de soporte institucional.</p></div>
            </div>
        </article>
