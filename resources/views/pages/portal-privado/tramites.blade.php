...
<section class="py-10 md:py-12">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
        <div class="inst-card p-5 md:p-6 border-primary/25">
            ...
            <p class="mt-2 text-slate-600">Seguimiento y gestion de solicitudes internas.</p>
            @include('pages.portal-privado.partials.nav')
        </div>

        <div class="grid md:grid-cols-2 gap-4">
            <article class="inst-card p-5 border-primary/20">
                <p class="text-xs uppercase tracking-[0.12em] text-slate-500 font-bold">Tramite activo</p>
                <p class="mt-1 text-xl font-black text-secondary">Constancia de habilidad profesional</p>
                <p class="mt-2 text-sm text-slate-600">Estado: En revision administrativa</p>
            </article>
            <article class="inst-card p-5 border-primary/20">
                <p class="text-xs uppercase tracking-[0.12em] text-slate-500 font-bold">Tramite reciente</p>
                <p class="mt-1 text-xl font-black text-secondary">Actualizacion de datos profesionales</p>
                <p class="mt-2 text-sm text-slate-600">Estado: Aprobado</p>
            </article>
        </div>
    </div>
</section>
