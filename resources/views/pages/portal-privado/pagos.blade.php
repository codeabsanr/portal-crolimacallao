...
<section class="py-10 md:py-12">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
        <div class="inst-card p-5 md:p-6 border-primary/25">
            ...
            <p class="mt-2 text-slate-600">Controla cuotas, comprobantes y movimientos.</p>
            @include('pages.portal-privado.partials.nav')
        </div>

        <div class="grid md:grid-cols-3 gap-4">
            <article class="inst-card p-5 border-primary/20">
                <p class="text-xs uppercase tracking-[0.12em] text-slate-500 font-bold">Saldo pendiente</p>
                <p class="mt-1 text-2xl font-black text-primary">S/ 0.00</p>
            </article>
            <article class="inst-card p-5 border-primary/20">
                <p class="text-xs uppercase tracking-[0.12em] text-slate-500 font-bold">Ultimo pago</p>
                <p class="mt-1 text-2xl font-black text-secondary">S/ 120.00</p>
                <p class="text-sm text-slate-600">Enero 2026</p>
            </article>
            <article class="inst-card p-5 border-primary/20">
                <p class="text-xs uppercase tracking-[0.12em] text-slate-500 font-bold">Estado financiero</p>
