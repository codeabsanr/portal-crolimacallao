    ...
    <div class="hidden md:block w-full bg-secondary text-white text-xs border-b border-primary/20">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-2 flex flex-wrap items-center justify-between gap-2">
            ...
            <div class="flex items-center gap-4">
                ...
                <a href="{{ route('admin.intranet') }}" class="hover:text-brand-gold-light transition-colors">Intranet</a>
            </div>
        </div>
    </div>

    <header x-data="{ open: false, panel: 'main' }" @keydown.escape.window="open = false; panel = 'main'" class="w-full bg-surface-light border-b border-slate-200 shadow-md">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="h-16 md:h-20 flex items-center justify-between gap-3 md:gap-4">
                <a href="{{ route('home') }}" class="flex items-center gap-2 md:gap-3 min-w-0">
                    <img src="{{ asset('assets/img/logo-circular.png') }}" alt="Logo CRO III Lima-Callao" class="h-10 w-10 md:h-12 md:w-12 object-contain" />
                ...
                <div class="hidden md:flex items-center">
                    <a href="{{ route('admin.intranet') }}" class="inst-btn-primary !py-2">Colegiatura</a>
                </div>
                ...
                <div class="px-4 py-4 pb-[max(1.25rem,env(safe-area-inset-bottom))]">
                    ...
                    <div x-show="panel === 'main'" x-transition.opacity>
                        ...
                        <div class="mt-6 space-y-3">
                            ...
                            <a @click="open = false; panel = 'main'" href="{{ route('admin.intranet') }}" class="flex items-center justify-between border border-white/50 p-4">
                                <div class="flex items-center gap-3">
